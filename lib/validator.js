...
Validator.prototype.addSubSchema = function addSubSchema(baseuri, schema) {
  ...
  this.addSubSchemaArray(ourBase, (Array.isArray(schema.extends) ? schema.extends : [ schema.extends ]));
...
types.object = function testObject(instance) {
  ...
  return instance && (typeof instance) === 'object' && !Array.isArray(instance) && !helpers.isDate(instance);
};
