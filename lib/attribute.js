...
validators.properties = function validateProperties(instance, schema, options, ctx) {
  if(instance === null || 'object'  !== typeof instance) { return; }
  var result = new ValidatorResult(instance, schema, options, ctx);
  ...
  if (instance === undefined && schema.required === true) {
    ...
    schema.required.forEach(function(n) {
      if(instance[n] === undefined) {
        if (options.default && schema.properties && schema.properties[n] && undefined !== schema.properties[n].default) {
          instance[n] = JSON.parse(JSON.stringify(schema.properties[n].default));
        } else {
          result.addError({
            name: 'required',
            argument: n,
