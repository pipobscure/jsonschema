...
import * as urilib from 'url';

export function ValidationError(message, instance, schema, propertyPath, name, argument) {
  if (propertyPath) {
...
export function SchemaContext(schema, options, propertyPath, base, schemas) {
  this.schema = schema;
...
export function isRegExp(obj) {
  return ('object' === typeof obj) && (obj !== null) && Object.prototype.toString.call(obj) === '[object RegExp]';
}
export function isDate(obj) {
  return ('object' === typeof obj) && (obj !== null) && Object.prototype.toString.call(obj) === '[object Date]';
}
 ...
 * @return {String}
 */
export function encodePointer(a) {
